    ...
    <section id="hero">
      ...
      <div className="socials">
        <a
          ...
          aria-label="GitHub"
          style={{ margin: '-0.15rem 0.5rem', color: 'inherit', display: 'inline-block' }}
        >
          <svg
            width="32"
            height="32"
        ...
        <a
          ...
          rel="noopener noreferrer"
          aria-label="LinkedIn"
          style={{ margin: '0 0.5rem', color: 'inherit', display: 'inline-block' }}
        >
          <svg
            width="32"
            height="32"
        ...
        <a
          ...
          aria-label="Email"
          style={{ margin: '0 0.65rem', color: 'inherit', display: 'inline-block' }}
        >
          <svg
            width="32"
            height="32"
